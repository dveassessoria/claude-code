#!/usr/bin/env python3
"""
onboarding-marketingops/api.py
...
Diferença pra onboarding-revops: MarketingOps é o downsell (sem CRM,
sem estruturação de processo comercial completo, sem fase de Sucesso do
Cliente/LTV). Ver .contexto/empresa.md para a lista de entregáveis de cada oferta.
"""
...
ENTREGAVEIS = """\
# Entregáveis MarketingOps

1. Matriz Ideal de Cliente
2. Gestão dos Anúncios Online (Meta Ads e Google Ads)
3. Acompanhamento e Otimização Semanal
4. Anúncios Estáticos
5. Análise Pro Sales
6. Playbook de Vendas
7. Reunião On-line a cada 15 dias
8. Atendimento diário no grupo de WhatsApp
"""
...
def clickup_setup(company, onboarding_file, date_str, tldv_url):
    """
    Creates full ClickUp structure for a new MarketingOps client.
    ...
    _log('[9/9] Criando tarefas de onboarding (47 tarefas — ~17s)...')
...
# ── clickup_tarefas ───────────────────────────────────────────────────────────
# Igual ao onboarding-revops, exceto: sem fase "Sucesso do Cliente" e sem as
# tarefas de CRM/estruturação comercial completa em "Comercial" (não fazem
# parte do escopo de MarketingOps — ver .contexto/empresa.md).
    ...
    'children': [
        {
            ...
            'children': [
                ...
                },
                {
                    ...
                    'description': 'Fazer a reunião de onboarding para alinhar objetivos, escopo, expectativas e forma de trabalho do projeto MarketingOps. Devemos gravar essa reunião com o TLDV e seguir o escopo do documento da reunião de onboarding.\n\nDefinição de pronto: Reunião realizada e principais decisões registradas no documento de onboarding.\nResponsável: Customer Success',
                },
                {
                ...
                },
                {
                    ...
                    'description': 'Criar e organizar as pastas do projeto do cliente para centralizar todos os arquivos no Google Drive. Pastas: Anúncios, Documentos, Comercial, Identidade Visual, Fotos e Vídeos, Listas de Clientes, Planilhas, Contrato.\n\nDefinição de pronto: Google Drive criado com estrutura padrão e compartilhado no grupo do cliente.\nResponsável: Customer Success',
                },
                {
                    'name': 'Coletar Acessos Necessários',
                    'description': 'Solicitar e validar todos os acessos essenciais para execução do projeto: Acesso Wordpress, Domínio, Hospedagem, Playbook de Vendas, Meta Ads, Google Ads.\n\nDefinição de pronto: Todos os acessos recebidos, testados e funcionando.\nResponsável: Customer Success',
                },
                {
        ...
        },
        {
            ...
            'children': [
                ...
                },
                {
                    ...
                    'description': 'Analisar como o cliente se posiciona hoje no digital em todos os canais ativos, mapeando gargalos, alavancas de crescimento e próximos passos. Entregável: documento base gerado pela skill docs-base-cliente.\n\nDefinição de pronto: Análise registrada em Google Docs com pontos fortes, pontos fracos e oportunidades.\nResponsável: Davi',
                },
                {
                ...
                {
                    'name': 'Criar Planejamento MarketingOps',
                    'description': 'Consolidar todas as decisões da fase de diagnóstico em um plano único de ação.\n\nDefinição de pronto: Planejamento MarketingOps documentado e validado internamente.\nResponsável: Líder de Receita',
                },
                {
        ...
        },
        {
            ...
            'children': [
                ...
                {
                    'name': 'Comercial',
                    'description': 'MarketingOps não inclui estruturação de processo comercial nem implementação de CRM (exclusivos do RevOps). Aqui entram apenas os entregáveis de apoio comercial previstos na oferta.',
                    'children': [
                        ...
                        {'name': 'Criar Planilha de Acompanhamento', 'description': ''},
                    ],
                },
            ],
        },
